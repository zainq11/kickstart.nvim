...
-- NOTE: LSP configuration has been moved to lua/custom/plugins/lsp.lua
...
-- NOTE: LSP formatting is now handled in lua/custom/plugins/lsp.lua
-- NOTE: Go setup is handled by ray-x/go.nvim plugin
